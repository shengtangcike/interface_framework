...
class Excel(object):
    ...
    def get_row_valuesall(self,sheet_name=None):
...
if __name__ == '__main__':
    excel = Excel(r'E:\pyworkspace\interface_test_framework\TestData\接口测试数据.xlsx')
    ...
    print(excel.get_row_valuesall("测试用例集"))
