...
def get_test_case_sheet_names(test_data_excel_path):
    ...
    for row in test_cases_wb.get_row_valuesall():
...
if __name__=="__main__":
    # path = r"E:\pyworkspace\interface_framework\TestData\接口测试数据.xlsx"
    # # print(get_test_case_sheet_names(path))
    # print(test_cases_from_test_data_sheet(path,"博客api测试"))
    s = '{"username":"testman${unique_num1}", "password":"123456789abc","email":"sed@qq.com"}'
    print(data_handler(s))
    # print(global_vars)
